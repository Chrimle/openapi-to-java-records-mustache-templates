...
@Schema(name = "ExampleRecordOneImplements", description = "Example of an Record which implements an interface.")
...
public class ExampleRecordOneImplements implements io.github.chrimle.o2jrm.interfaces.TestInterfaceOne {

  private Optional<Boolean> field1 = Optional.empty();

  public ExampleRecordOneImplements field1(Boolean field1) {
  ...
  public boolean equals(Object o) {
    ...
    ExampleRecordOneImplements exampleRecordOneImplements = (ExampleRecordOneImplements) o;
    return Objects.equals(this.field1, exampleRecordOneImplements.field1);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExampleRecordOneImplements {\n");
