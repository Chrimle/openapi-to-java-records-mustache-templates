...
@Schema(name = "ExampleNullableRecord", description = "Example of a Record")
...
public class ExampleNullableRecord {

  private Optional<Boolean> field1 = Optional.empty();

  public ExampleNullableRecord field1(Boolean field1) {
  ...
  public boolean equals(Object o) {
    ...
    ExampleNullableRecord exampleNullableRecord = (ExampleNullableRecord) o;
    return Objects.equals(this.field1, exampleNullableRecord.field1);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExampleNullableRecord {\n");
