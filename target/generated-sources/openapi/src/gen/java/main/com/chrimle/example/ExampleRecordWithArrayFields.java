...
public record ExampleRecordWithArrayFields(
    ...
    public ExampleRecordWithArrayFields(
            @javax.annotation.Nonnull final List<Boolean> field1,
            @javax.annotation.Nonnull final List<Boolean> field2,
            @javax.annotation.Nonnull final List<Boolean> field3) { 
