...
public record ExampleRecordWithSetFields(
    @jakarta.annotation.Nonnull Set<Boolean> field1,
    @jakarta.annotation.Nonnull Set<Boolean> field2,
    @jakarta.annotation.Nonnull Set<Boolean> field3) {

  public ExampleRecordWithSetFields(
      @jakarta.annotation.Nullable final Set<Boolean> field1,
      @jakarta.annotation.Nullable final Set<Boolean> field2,
      @jakarta.annotation.Nullable final Set<Boolean> field3) { 
