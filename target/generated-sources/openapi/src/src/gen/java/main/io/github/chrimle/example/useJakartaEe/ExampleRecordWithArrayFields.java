...
public record ExampleRecordWithArrayFields(
    @jakarta.annotation.Nonnull List<Boolean> field1,
    @jakarta.annotation.Nonnull List<Boolean> field2,
    @jakarta.annotation.Nonnull List<Boolean> field3) {

  public ExampleRecordWithArrayFields(
      @jakarta.annotation.Nullable final List<Boolean> field1,
      @jakarta.annotation.Nullable final List<Boolean> field2,
      @jakarta.annotation.Nullable final List<Boolean> field3) { 
