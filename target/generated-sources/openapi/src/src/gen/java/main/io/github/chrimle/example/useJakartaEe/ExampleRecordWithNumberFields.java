...
public record ExampleRecordWithNumberFields(
    @jakarta.annotation.Nonnull BigDecimal field1,
    @jakarta.annotation.Nonnull BigDecimal field2,
    @jakarta.annotation.Nonnull BigDecimal field3) {

  public ExampleRecordWithNumberFields(
      @jakarta.annotation.Nonnull final BigDecimal field1,
      @jakarta.annotation.Nonnull final BigDecimal field2,
      @jakarta.annotation.Nonnull final BigDecimal field3) { 
    this.field1 = field1;
    this.field2 = field2;
    this.field3 = field3;
  }
