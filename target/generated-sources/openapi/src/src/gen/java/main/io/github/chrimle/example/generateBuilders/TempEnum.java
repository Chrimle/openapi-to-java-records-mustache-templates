...
public enum TempEnum {
   ...
   * @return a {@link TempEnum } with the matching value
   * @throws IllegalArgumentException if no enum has a value matching the given value
   */
  public static TempEnum fromValue(final String value) {
    for (final TempEnum constant : TempEnum.values()) {
