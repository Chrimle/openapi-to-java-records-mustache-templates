...
public record ExampleRecordWithExampleRecordFields(
    @jakarta.annotation.Nonnull ExampleRecord field1,
    @jakarta.annotation.Nonnull ExampleRecord field2,
    @jakarta.annotation.Nonnull ExampleRecord field3) {

  public ExampleRecordWithExampleRecordFields(
      @jakarta.annotation.Nonnull final ExampleRecord field1,
      @jakarta.annotation.Nonnull final ExampleRecord field2,
      @jakarta.annotation.Nonnull final ExampleRecord field3) { 
    this.field1 = field1;
    this.field2 = field2;
    this.field3 = field3;
  }
