...
public record ExampleRecordWithExampleEnumFields(
    @jakarta.annotation.Nonnull ExampleEnum field1,
    @jakarta.annotation.Nonnull ExampleEnum field2,
    @jakarta.annotation.Nonnull ExampleEnum field3) {

  public ExampleRecordWithExampleEnumFields(
      @jakarta.annotation.Nonnull final ExampleEnum field1,
      @jakarta.annotation.Nonnull final ExampleEnum field2,
      @jakarta.annotation.Nonnull final ExampleEnum field3) { 
    this.field1 = field1;
    this.field2 = field2;
    this.field3 = field3;
  }
